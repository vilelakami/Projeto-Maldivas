...
// inicializando bitmaps e fontes
...
int main() {
    ...
    //instalando teclado, mouse e addons
    al_install_keyboard();
    al_install_mouse();
    al_init_image_addon();
    al_init_font_addon();
    ...
    // declarando tela inicial = menu e add variavel booleana pra entrar e sair do jogo
    ...
    while (!sair) {
        ...
        if (estado_jogo == MENU) {
            ...
            //verificar click do mouse mas n funciona
        ...
        // usando um recurso de renderização que achei na internet, assim ele verifica a fase atual e muda
            ...
            //verifica se alguma tecla foi clicada e se foi o enter
